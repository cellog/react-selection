...
export default class mouseMath {
  ...
  static objectsCollide(nodeA, nodeB, tolerance = 0, key = '(unknown)', debugCallback) {
    const {
      top: aTop,
      left: aLeft,
      right: aRight = aLeft,
    ...
    if (Debug.DEBUGGING.debug && Debug.DEBUGGING.bounds) Debug.debugBounds(mouseMath.getBoundsForNode, nodeA, nodeB, key)
